...
|--------|---------|--------------|
| KeePass2-HaveIBeenPwned | v1.3.6 | Dieses Plugin prüft Nutzernamen, Passwörter und Domains auf Kompromittierung. |
| KeePassOTP | v1.12 | Dieses Plugin ermöglicht die Speicherung, Verwaltung und den Abruf von OTPs in KeePass. In Verbindung mit KeePassRPC können OTP-Felder so auch vollautomatisch befüllt werden. |
